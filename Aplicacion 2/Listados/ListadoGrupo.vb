...
Public Class ListadoGrupo
    ...
    Private Sub ListadoGrupo_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub BotonGuardar_Click(sender As Object, e As EventArgs) Handles BotonGuardar.Click
        ...
        If DataGridView.RowCount > 0 Then
            ...
            If MaestroGrupo.Visible = True Then
                ...
                MaestroGrupo.TextBox1.Text = DataGridView.Item("ColumnaID", DataGridView.SelectedRows(0).Index).Value
                MaestroGrupo.TextBox2.Text = DataGridView.Item("ColumnaGrupo", DataGridView.SelectedRows(0).Index).Value
                MaestroGrupo.ComboSede.Text = DataGridView.Item("ColumnaSede", DataGridView.SelectedRows(0).Index).Value
